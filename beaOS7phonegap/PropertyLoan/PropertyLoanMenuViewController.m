//
//  PropertyLoanMenuViewController.m
//  BEA
//
...
@interface PropertyLoanMenuViewController ()

@end

@implementation PropertyLoanMenuViewController
...
- (void)setMenus
{
    ...
    mvc0 = [[PropertyLoanEnquiryViewController alloc] initWithNibName:@"PropertyLoanEnquiryViewController" bundle:nil];
    mvc1 = [[PropertyLoanCalculatorViewController alloc] initWithNibName:@"PropertyLoanCalculatorViewController" bundle:nil];
    ...
    NSLog(@"debug PropertyLoanCalculatorViewController viewDidLoad 0:%@", mvc0);
    NSLog(@"debug PropertyLoanEnquiryViewController viewDidLoad 1:%@", mvc1);
...
//    NSLog(@"debug ConsumerLoanMenuViewController viewDidLoad mmenuv2:%f--%f", mmenuv2.frame.size.width, mmenuv2.frame.size.height);
    ...
    NSArray* a_texts = [NSArray arrayWithObjects:
                        ...
                        NSLocalizedString(@"Calculator", nil),
...
- (void)viewDidLoad
{
    ...
    NSLog(@"debug 20140128 PropertyLoanCalculatorViewController viewDidLoad:%@", self.view);
