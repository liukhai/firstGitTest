//
//  InsuranceEnquiryViewController.m
//  BEA
//
...
@implementation InsuranceEnquiryViewController
...
-(void)requestDatas {
    NSURL* url= [NSURL URLWithString:[NSString stringWithFormat:@"%@getenquiry.api?type=1&lang=%@",
...
-(void)initView
{
    ...
    for (int i=0; i<[items_data count]; i++) {
        ...
        ecvc.nsSubject = NSLocalizedString(@"insurance.enquires.EmailTitle",nil);
        ecvc.navvc = [InsuranceUtil me].Insurance_view_controller;
