//
//  ConsumerLoanMenuViewController.m
//  BEA
//
...
@interface ConsumerLoanMenuViewController ()

@end

@implementation ConsumerLoanMenuViewController
...
- (void)setMenus
{
    ...
    mvc0 = [[ConsumerLoanEnquiryViewController alloc] initWithNibName:@"ConsumerLoanEnquiryViewController" bundle:nil];
    mvc1 = [[ConsumerLoanListViewController alloc] initWithNibName:@"ConsumerLoanListViewController" bundle:nil];
    mvc2 = [[ConsumerLoanApplicationViewController alloc] initWithNibName:@"ConsumerLoanApplicationViewController" bundle:nil];
...
//    mv_rmvc.rmUtil.noPop = YES;
    ...
    NSLog(@"debug ConsumerLoanMenuViewController viewDidLoad 0:%@", mvc0);
    NSLog(@"debug ConsumerLoanMenuViewController viewDidLoad 1:%@", mvc1);
    NSLog(@"debug ConsumerLoanMenuViewController viewDidLoad 2:%@", mvc2);
...
-(void)showMenu:(int)show
{
    ...
    ((ConsumerLoanApplicationViewController *)mvc2).isShow = NO;
    
    if (show == 2) {
        ((ConsumerLoanApplicationViewController *)mvc2).isShow = YES;
    }
