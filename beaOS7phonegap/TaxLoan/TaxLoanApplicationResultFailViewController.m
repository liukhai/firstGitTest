//
//  TaxLoanApplicationResultFailViewController.m
//  BEA
//
...
@implementation TaxLoanApplicationResultFailViewController
...
//    bgv.frame = CGRectMake(0, 0, 320, 367+[[MyScreenUtil me] getScreenHeightAdjust]);
	...
	lbTag00.text = NSLocalizedString(@"Application rejected",nil);
	lbTag01.text = NSLocalizedString(@"TaxLoanApplicationResultTag01",nil);
	lbTag02.text = NSLocalizedString(@"Message :",nil);
