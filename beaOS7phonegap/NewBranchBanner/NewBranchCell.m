...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier mystyle:(int)sid{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
		...
		tel = [[UIButton alloc] initWithFrame:CGRectMake(25, 53, 150, 25)];
		...
		tel2 = [[UIButton alloc] initWithFrame:CGRectMake(25, 70, 150, 25)];
		tel2.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
		tel2.titleLabel.font = [UIFont systemFontOfSize:14];
		tel2.backgroundColor = [UIColor clearColor];
		[tel2 setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
		[tel2 addTarget:self action:@selector(call:) forControlEvents:UIControlEventTouchUpInside];
		[self.contentView addSubview:tel2];
		
		tel3 = [[UIButton alloc] initWithFrame:CGRectMake(25, 87, 150, 25)];
		tel3.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
		tel3.titleLabel.font = [UIFont systemFontOfSize:14];
		tel3.backgroundColor = [UIColor clearColor];
		[tel3 setTitleColor:[UIColor blueColor] forState:UIControlStateNormal];
		[tel3 addTarget:self action:@selector(call:) forControlEvents:UIControlEventTouchUpInside];
		[self.contentView addSubview:tel3];
...
-(void)call:(UIButton *)button{
	NSLog(@"NewBranchCell phone call pressed");
...
-(void) alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
	if (buttonIndex==1) {
		NSLog(@"NewBranchCell Call %@",[tel titleForState:UIControlStateNormal]);
