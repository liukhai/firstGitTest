//
//  ATMAdvanceSearchListCMSViewController.h
//  BEA Surprise
//
...
@interface ATMAdvanceSearchListCMSViewController : UIViewController
...
//	IBOutlet UIButton *supremegoldbutton, *atmbutton, *branchbutton;
    ...
    IBOutlet UILabel *lbDistName;
    RotateMenu2ViewController* v_rmvc;
    NSString* willBack;
    ATMNearBySearchDistCMSViewController* distVC;
    int menuIndex;
}

@property(nonatomic, retain) ATMNearBySearchDistCMSViewController* distVC;
@property(nonatomic, retain) NSString* willBack;
