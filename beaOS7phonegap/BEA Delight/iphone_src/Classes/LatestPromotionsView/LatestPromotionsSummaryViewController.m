...
@implementation LatestPromotionsSummaryViewController
...
//    self.view.frame = CGRectMake(0, 0, 320, 460+[[MyScreenUtil me] getScreenHeightAdjust_20]);
...
//    bookmark.frame = CGRectMake(216, 423+[[MyScreenUtil me] getScreenHeightAdjust], 96, 37);
    ...
    detail.frame = CGRectMake(detail.frame.origin.x, detail.frame.origin.y+[[MyScreenUtil me] getScreenHeightAdjust], detail.frame.size.width, detail.frame.size.height);
    ...
    contact_info.frame = CGRectMake(contact_info.frame.origin.x, contact_info.frame.origin.y+[[MyScreenUtil me] getScreenHeightAdjust], contact_info.frame.size.width, contact_info.frame.size.height);
    
	title_label.text = [NSString stringWithFormat:@"%@\n%@",NSLocalizedString(@"BEA Credit Card",nil),NSLocalizedString(@"Latest Promotions",nil)];
	[tnc setTitle:NSLocalizedString(@"T&C",nil) forState:UIControlStateNormal];
	[share setTitle:NSLocalizedString(@"Share Offer2",nil) forState:UIControlStateNormal];
//	[bookmark setTitle:NSLocalizedString(@"Add to Bookmark",nil) forState:UIControlStateNormal];
	...
	if ([merchant_logo_list count]==0) {
		preview.frame = CGRectMake(0, 0, 320, 140);
...
//	contact_info.center = CGPointMake(240, footer + detail.frame.size.height/2);
    ...
    if ([bookmark_data isOfferExist:merchant_info InGroup:4]) {
...
-(IBAction)contactButtonPressed:(UIButton *)button {
	...
	[self.navigationController pushViewController:contact_controller animated:FALSE];
...
-(IBAction)tncButtonPressed:(UIButton *)button {
	...
	[self.navigationController pushViewController:tnc_controller animated:FALSE];
...
-(IBAction)bookmarkButtonPressed:(UIButton *)button {
	Bookmark *bookmark_data = [[Bookmark alloc] init];
//	[bookmark_data addBookmark:merchant_info ToGroup:4];
//	[bookmark_data release];
...
//	[alert release];
    ...
    NSString *pageTheme = [[PageUtil pageUtil] getPageTheme];
    if ([bookmark_data isOfferExist:merchant_info InGroup:4]) {
        [bookmark_data removeBookmark:merchant_info InGroup:4];
        if ([pageTheme isEqualToString:@"1"]) {
...
//             createComposerWithSubject:[NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"BEA Credit Card",nil), NSLocalizedString(@"Latest Promotions",nil)]
//             Message:[[[NSString stringWithFormat:@"%@ - %@\n\n%@\n%@\n\n%@",
//                        NSLocalizedString(@"Latest Promotions",nil),
...
//                        contact] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]
