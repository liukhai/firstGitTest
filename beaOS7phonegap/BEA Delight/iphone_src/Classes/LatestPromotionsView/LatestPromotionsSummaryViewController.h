...
@interface LatestPromotionsSummaryViewController : UIViewController <UIAlertViewDelegate> {
	IBOutlet UIButton *ecoupon, *detail, *tnc, *share, *bookmark, *contact_info;
	...
	int alert_action;
    NSInteger pushType; // 1:Favourite
    BOOL isInit;
}
