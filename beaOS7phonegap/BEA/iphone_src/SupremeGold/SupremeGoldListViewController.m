//
//  SupremeGoldListViewController.m
//  BEA
//
...
@implementation SupremeGoldListViewController
...
- (void)viewDidLoad {
    ...
    table_view.accessibilityElementsHidden = YES;
    ...
    self.lb_pagetitle.text = NSLocalizedString(@"SupremeGoldOffers",nil);
    self.lb_pagetitle.accessibilityLabel = NSLocalizedString(@"SupremeGoldOffers",nil);
...
- (void) loadPlistData{
	NSLog(@"debug SupremeGoldListViewController loadPlistData starts");
    ...
    ASIHTTPRequest* asi_request = [[ASIHTTPRequest alloc]
                                   ...
                                   [NSURL
                                    URLWithString:
                                    [NSString
                                     stringWithFormat:@"%@getinfo.api?type=15&lang=%@",
	...
	NSLog(@"debug SupremeGoldListViewController loadPlistData end");
}
...
- (void)requestFailed:(ASIHTTPRequest *)request {
    NSLog(@"SupremeGoldListViewController >> requestFailed:%@", request.error);
...
-(void) parserDidEndDocument:(NSXMLParser *)parser {
	NSLog(@"debug SupremeGoldListViewController parserDidEndDocument:%d outlets",[self.items_data count]);
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"debug SupremeGoldListViewController cellForRowAtIndexPath:%@", cell);
    return cell;
}
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //                                                         url2:url2
    //                                                    url2label:url2label];
    [[SupremeGoldUtil me] showSupremeGoldViewController:@"SupremeGoldListViewController"
