...
//        self.mTelDomainCard = @"http://hkbea.mtel.ws/java/bea/dev/";
        ...
        self.URLOfMBAIOLogonShow = [NSString stringWithFormat:@"%@/servlet/MBAIOLogonShow?act=ipa&",CYBDomain,nil];        
        ...
        self.m_sURLMBLogonShow				= [NSString stringWithFormat:@"%@/servlet/MBLogonShow?act=ipa&",CYBDomain,nil];
